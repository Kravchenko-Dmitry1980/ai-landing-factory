/** Public path to the UII-style AI cat assistant hero mascot (Stage P.7.X). */
export const WOW_CAT_MASCOT_SRC = "/assets/wow/cat-assistant.png";

/** Relative path inside the offline Interactive WOW ZIP (file:// safe). */
